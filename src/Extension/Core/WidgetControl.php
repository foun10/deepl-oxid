...
/**
 * WidgetControl extends ShopControl in plain PHP terms, and its own runOnce() is not overridden,
 ...
 * explicitly here, with its own runOnce() override, guarantees the fix runs on this class's own
