 ...
 * not the table - is what Composer actually resolves against. Nothing else ties the two
 * together, and the sibling EasyCache module drifted exactly there: its OXID 7 branch
 * advertised "^7.4 || ^8.0" while CI ran 8.0 upwards, so a PHP 7.4 shop could have resolved
 * a Twig-only release line and rendered nothing.
 */
